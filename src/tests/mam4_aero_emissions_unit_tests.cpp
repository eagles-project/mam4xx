...
TEST_CASE("test_init_dust_dmt_vwr",
  ...
  Real dust_dmt_vwr_ref[dust_nbin] = {0.78056703442146215e-6,  0.38983341139985417e-5};
  ...
  for (int i = 0; i < dust_nbin; ++i) {
    ...
    logger.debug("reference value of dust_dmt_vwr[{}] = {}", i, dust_dmt_vwr_ref[i]);
  }

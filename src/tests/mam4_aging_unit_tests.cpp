...
TEST_CASE("mam4_pcarbon_aging_1subarea", "mam4_aging_process") {
  ...
  Real qaer_cur[mam4::AeroConfig::num_aerosol_ids()][mam4::AeroConfig::num_modes()] = {};
  Real qaer_del_cond[mam4::AeroConfig::num_aerosol_ids()][mam4::AeroConfig::num_modes()] =
      {};
  Real qaer_del_coag[mam4::AeroConfig::num_aerosol_ids()][mam4::AeroConfig::num_modes()] =
      {};

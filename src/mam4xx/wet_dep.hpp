...
// Function to call to initialize the arrays passed to the aero_model_wetdep
// function. This is a host function, so scavimptblvol and scavimptblnum need
// to be synced to device.
